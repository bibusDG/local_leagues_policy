...
This privacy policy is applicable to the Local Leagues app (hereinafter referred to as "Application") for mobile devices, which was developed by Dominik Grosser (hereinafter referred to as "Service Provider") as a a Freemium service. This service is provided "AS IS".
...
The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. The Service Provider will retain Automatically Collected information for up to 24 months and thereafter may store it in aggregate. If you'd like the Service Provider to delete User Provided Data that you have provided via the Application, please contact them at bibusapps@gmail.com and we will respond in a reasonable time. Please note that some or all of the User Provided Data may be required in order for the Application to function properly.
...
These terms and conditions applies to the Local Leagues app (hereby referred to as "Application") for mobile devices that was created by Dominik Grosser (hereby referred to as "Service Provider") as a Freemium service.
